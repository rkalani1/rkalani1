...
Public-use boundary: Links must point only to public-safe demos or public educational tools. Real clinical or operational workflows require an approved controlled environment.
